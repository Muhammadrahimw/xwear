...
import {addLike, removeShop} from "../../redux/slices/itemSlice";
...
const Shop = () => {
	let shopData = useSelector((state) => state.items.shop || []);
	...
	let removeShopFunc = (data) => {
		if (data) {
			dispatch(removeShop({data}));
		}
	};
